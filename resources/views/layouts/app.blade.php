        ...
        <aside class="hidden w-72 flex-shrink-0 flex-col justify-between border-r border-slate-200 bg-white p-6 md:flex">
            <div>
                ...
                <nav class="space-y-1.5">
                    ...
                    <a href="#" class="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-600 hover:bg-slate-50 transition duration-200">Analytics</a>
                    <a href="#" class="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-600 hover:bg-slate-50 transition duration-200">AI Copilot</a>
                    <a href="#" class="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-600 hover:bg-slate-50 transition duration-200">POS Cashier</a>
                    <a href="#" class="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-600 hover:bg-slate-50 transition duration-200">Pengaturan</a>
                </nav>
            </div>
